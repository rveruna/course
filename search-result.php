                        ...
                        <div class="col-md-6">
                            <div id="sb-search" class="sb-search">
                                <form role="search" action="search-result.php" method="GET">
                                    <input class="sb-search-input" placeholder="Enter your search term..." id="course" name="search">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="searchtitle">
                                <p class="lead">2 posts found for 'blog' term</p>
                            </div>
                            <article>
                            ...
                            <article>
                                ...
                                <p>
                                    ...
                                    docendi democritum vix no. Quo ne adhuc semper vituperata, quo ex vide justo nusquam, pro impedit philosophia an. Ad sed veri choro utroque, aeque definiebas an sea. Populo conceptam te qui. Pri eu doming urbanitas,
                                    eu omnes qualisque splendide mei. Has admodum honestatis no, cu sonet nullam vim.
                                </p>
                                <div class="bottom-article">
                                    <a href="#" class="readmore pull-right">Continue reading <i class="fa fa-angle-right"></i></a>
                                </div>
